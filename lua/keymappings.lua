...
-- Search and Replace
map("n", "<leader>rs", ":%s/\\v", { desc = "Substitute in same line" })
map("n", "<leader>rf", ":s/\\v", { desc = "Substitute and replace in file" })
map("v", "<leader>rv", ":s/\\%V", { desc = "Substitute in visual selection" })
